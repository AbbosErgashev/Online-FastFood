<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Online_FastFood.User.Menu" %>
                        ...
                        <ItemTemplate>
                            <div class="col-sm-6 col-lg-4 all <%# Regex.Replace(Eval("CategoryName").ToString().ToLower(), @"\s+", "") %>">
                                <div class="box">
                                    <div>
                                        <div class="img-box">
                                            <img src="<%# Online_FastFood.Connection.Utils.GetImageUrl( Eval("ImageUrl")) %>"
                                                alt="">
                                        </div>
                                        <div class="detail-box">
                                            ...
                                            <div class="options">
                                                ...
                                                <asp:LinkButton ID="lbAddToCard" runat="server"
                                                    CommandName="addToCard"
