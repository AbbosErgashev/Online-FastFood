                                ...
                                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active text-info"
                                            ...
                                            aria-selected="true">
                                            <i class="fa fa-id-badge mr-2" title="Basic Info Icon"></i>
                                            Basic Info 
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-info"
                                            ...
                                            aria-selected="false">
                                            <i class="fa fa-clock-o mr-2" title="Purchased History Icon"></i>
                                            Purchased History 
                                        </a>
                                    </li>
                                </ul>
