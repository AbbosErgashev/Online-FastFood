<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Online_FastFood.User.Cart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <img width="60" src='<%# Online_FastFood.Connection.Utils.GetImageUrl(Eval("ImageUrl")) %>' alt="" />
                    </td>
                    ...
                    <td>$<asp:Label ID="lblTotalPrice" runat="server"
                        Text='<%# Eval("Price") %>'>
                    </asp:Label>
                    </td>
                    <td>
    ...
    <link href="../TempleteFiles/css/style.css" rel="stylesheet" />
    <script src="../TempleteFiles/js/custom.js"></script>
</asp:Content>
