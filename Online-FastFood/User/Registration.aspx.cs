...
namespace Online_FastFood.User
{
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (fuImageUser.HasFile)
            {
                if (Utils.IsValidExtension(fuImageUser.FileName))
                {
                    Guid obj = Guid.NewGuid();
                    fileExtension = Path.GetExtension(fuImageUser.FileName);
                    imagePath = "Images/User/" + obj.ToString() + fileExtension;
                    fuImageUser.PostedFile.SaveAs(Server.MapPath("~/Images/User/") + obj.ToString() + fileExtension);
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    actionName = userId == 0 ?
                        ...
                        "details updated succussful! <b><a href='Profile.aspx'>Can check here</a></b>";
                    lblMsg.Visible = true;
